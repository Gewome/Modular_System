    ...
    <nav class="bg-gradient-to-b from-blue-900 to-blue-600 shadow-md sticky top-0 z-50">
        ...
        <div class="md:hidden hidden" id="mobile-menu">
            <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-gradient-to-b from-blue-900 to-blue-600">
                <a href="<?php echo e(route('welcome')); ?>" class="text-white hover:text-blue-300 block px
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div class="rounded-lg overflow-hidden shadow-lg">
                    <img src="<?php echo e(asset('pictures/bnc_welc.jpg')); ?>" alt="School Building" class="w-full h-64 object-cover">
                </div>
                <div class="rounded-lg overflow-hidden shadow-lg">
                    <img src="<?php echo e(asset('pictures/comlab.jpg')); ?>" alt="Classroom" class="w-full h-64 object-cover">
                </div>
                <div class="rounded-lg overflow-hidden shadow-lg">
                    <img src="<?php echo e(asset('pictures/hallway.jpg')); ?>" alt="Library" class="w-full h-64 object-cover">
                </div>
            </div>
        </div>
    </div>
