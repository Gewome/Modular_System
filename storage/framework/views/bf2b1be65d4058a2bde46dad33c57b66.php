                                    ...
                                    <div class="p-4 hover:bg-gray-50 transition-colors">
                                        <div class="flex justify-between items-center">
                                            ...
                                            <div class="text-right">
                                                <p class="font-semibold text-green-600">₱<?php echo e(number_format($payment->amount, 2)); ?></p>
                                                <p class="text-sm text-gray-500"><?php echo e($payment->session_count); ?> session<?php echo e($payment->session_count > 1 ? 's' : ''); ?></p>
            ...
            const content = `
                <div class="space-y-4">
                    <div class="flex justify-between">
                        ...
                        <span class="font-medium">${receipt.course}</span>
                    </div>
                    <div class="flex justify-between">
                    ...
                    <div class="flex justify-between">
                        ...
                        <span class="font-semibold text-green-600">${receipt.amount}</span>
                    </div>
                    <div class="flex justify-between">
                    ...
                    <div class="flex justify-between">
                        ...
                        <span class="text-sm">${receipt.transaction}</span>
                    </div>
