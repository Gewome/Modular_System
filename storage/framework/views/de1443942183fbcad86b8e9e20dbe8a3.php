                ...
                <div class="flex flex-1 items-center">
                    <div class="relative group mr-6">
                        <?php if($enrollment && $enrollment->photo): ?>
                            <img src="<?php echo e(asset('storage/' . $enrollment->photo)); ?>" alt="Profile" class="w-24 h-24 rounded-full border-4 border-white shadow-md object-cover cursor-pointer" style="z-index: 2; position: relative;" onclick="document.getElementById('profile-pic-upload').click()">
                        <?php elseif($student && $student->photo): ?>
                            <img src="<?php echo e(asset('storage/' . $student->photo)); ?>" alt="Profile" class="w-24 h-24 rounded-full border-4 border-white shadow-md object-cover cursor-pointer" style="z-index: 2; position: relative;" onclick="document.getElementById('profile-pic-upload').click()">
                        <?php else: ?>
                    ...
                    <div class="text-center md:text-left">
                        <h1 class="text-2xl font-bold">
                            <?php if($enrollment): ?>
                                <?php echo e($enrollment->last_name ?? ''); ?><?php echo e($enrollment->last_name && $enrollment->first_name ? ', ' : ''); ?><?php echo e($enrollment->first_name ?? ''); ?><?php echo e($enrollment->middle_name ? ' ' . $enrollment->middle_name : ''); ?><?php echo e($enrollment->suffix_name ? ' ' . $enrollment->suffix_name : ''); ?>
                        ...
                        <p class="text-blue-100"><?php echo e($student->role ?? 'Student'); ?></p>
                        <div class="flex justify-center md:justify-start mt-2 space-x-2">
                            <span class="bg-blue-400 bg-opacity-30 px-3 py-1 rounded-full text-sm"><?php echo e($enrollment->program->name ?? 'No Program'); ?></span>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div>
                        ...
                        <ul class="space-y-3">
                            <li class="flex items-center">
                                ...
                                <span class="text-gray-600"><?php echo e($student->email ?? 'No email'); ?></span>
                            </li>
                            <li class="flex items-center">
                                <i class="fas fa-phone text-blue-500 mr-3 w-5"></i>
                                <span class="text-gray-600"><?php echo e($enrollment->phone ?? ($student->phone ?? 'No phone number')); ?></span>
                            </li>
                            <li class="flex items-center">
                                <i class="fas fa-map-marker-alt text-blue-500 mr-3 w-5"></i>
                                <span class="text-gray-600"><?php echo e($enrollment->address ?? ($student->address ?? 'No address')); ?></span>
                            </li>
                            <li class="flex items-center">
                                <i class="fas fa-birthday-cake text-blue-500 mr-3 w-5"></i>
                                <span class="text-gray-600">Birthdate: <span class="font-medium"><?php echo e($enrollment->birthdate ? \Carbon\Carbon::parse($enrollment->birthdate)->format('M d, Y') : 'Not specified'); ?></span></span>
                            </li>
                            <li class="flex items-center">
                                <i class="fas fa-user-clock text-blue-500 mr-3 w-5"></i>
                                <span class="text-gray-600">Age: <span class="font-medium"><?php echo e($enrollment->age ?? 'Not specified'); ?></span></span>
                            </li>
                            <li class="flex items-center">
                                <i class="fas fa-calendar-alt text-blue-500 mr-3 w-5"></i>
                                <span class="text-gray-600">Member since: <span class="font-medium"><?php echo e($student->created_at->format('M d, Y') ?? 'N/A'); ?></span></span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul class="space-y-3">
                            <li class="flex items-center">
                                ...
                                <span class="text-gray-600">Gender: <span class="font-medium"><?php echo e($enrollment->gender ?? 'Not specified'); ?></span></span>
                            </li>
                            <li class="flex items-center">
                                <i class="fas fa-ring text-blue-500 mr-3 w-5"></i>
                                <span class="text-gray-600">Civil Status: <span class="font-medium"><?php echo e($enrollment->civil_status ?? 'Not specified'); ?></span></span>
                            </li>
                            <?php if($enrollment->civil_status == 'Married'): ?>
                            <li class="flex items-center">
                                <i class="fas fa-heart text-blue-500 mr-3 w-5"></i>
                                <span class="text-gray-600">Spouse: <span class="font-medium"><?php echo e($enrollment->spouse_name ?? 'Not specified'); ?></span></span>
                            </li>
                            <?php endif; ?>
                            <li class="flex items-center">
                                <i class="fas fa-globe text-blue-500 mr-3 w-5"></i>
                                <span class="text-gray-600">Citizenship: <span class="font-medium"><?php echo e($enrollment->citizenship ?? 'Not specified'); ?></span></span>
                            </li>
                            <li class="flex items-center">
                                <i class="fas fa-pray text-blue-500 mr-3 w-5"></i>
                                <span class="text-gray-600">Religion: <span class="font-medium"><?php echo e($enrollment->religion ?? 'Not specified'); ?></span></span>
                            </li>
                            <li class="flex items-center">
                                <i class="fas fa-map-pin text-blue-500 mr-3 w-5"></i>
                                <span class="text-gray-600">Place of Birth: <span class="font-medium"><?php echo e($enrollment->place_of_birth ?? 'Not specified'); ?></span></span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul class="space-y-3">
                            <li class="flex items-center">
                                ...
                                <span class="text-gray-600">Father: <span class="font-medium"><?php echo e($enrollment->father_name ?? 'Not specified'); ?></span></span>
                            </li>
                            <li class="flex items-center">
                                <i class="fas fa-female text-blue-500 mr-3 w-5"></i>
                                <span class="text-gray-600">Mother: <span class="font-medium"><?php echo e($enrollment->mother_name ?? 'Not specified'); ?></span></span>
                            </li>
                            <li class="flex items-center">
                                <i class="fas fa-user-shield text-blue-500 mr-3 w-5"></i>
                                <span class="text-gray-600">Guardian: <span class="font-medium"><?php echo e($enrollment->guardian ?? 'Not specified'); ?></span></span>
                            </li>
                            <li class="flex items-center">
                                <i class="fas fa-home text-blue-500 mr-3 w-5"></i>
                                <span class="text-gray-600">Home Address: <span class="font-medium"><?php echo e($enrollment->address ?? ($student->address ?? 'Not specified')); ?></span></span>
                            </li>
                            <li class="flex items-center">
                                <i class="fas fa-phone-alt text-blue-500 mr-3 w-5"></i>
                                <span class="text-gray-600">Guardian Contact: <span class="font-medium"><?php echo e($enrollment->guardian_contact ?? 'Not specified'); ?></span></span>
                            </li>
                        </ul>
                    </div>
                </div>
