    ...
    <div class="relative top-10 mx-auto p-6 border w-full max-w-4xl shadow-xl rounded-lg bg-white">
        <div class="mt-2">
            ...
            <div class="flex justify-between items-center mb-6 pb-4 border-b border-gray-200">
                <div>
                    <h3 class="text-xl font-semibold text-gray-900">Edit User Information</h3>
                    <p class="text-sm text-gray-600 mt-1">Manage user details and account settings</p>
                </div>
                <button id="closeEditUserModal" class="text-gray-400 hover:text-gray-600 hover:bg-gray-100 p-2 rounded-full transition-colors">
                ...
                <div class="mb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-gray-50" id="userFullName" name="full_name" type="text" readonly>
                        </div>
                        <div>
                            <label class="block text-gray-700 text-sm font-medium mb-2" for="userUsername">
                                Username
                            </label>
                            <input class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-gray-50" id="userUsername" name="username" type="text" readonly>
                        </div>
                        <div>
                            <label class="block text-gray-700 text-sm font-medium mb-2" for="userRole">
                                Role
                            </label>
                            <input class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-gray-50" id="userRole" name="role" type="text" readonly>
                        </div>
                        <div>
                            <label class="block text-gray-700 text-sm font-medium mb-2" for="userEmail">
                                Email Address
                            </label>
                            <input class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-gray-50" id="userEmail" name="email" type="email" readonly>
                        </div>
                        <div>
                            <label class="block text-gray-700 text-sm font-medium mb-2" for="userPhone">
                                Phone Number
                            </label>
                            <input class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-gray-50" id="userPhone" name="phone" type="text" readonly>
                        </div>
                        <div>
                            <label class="block text-gray-700 text-sm font-medium mb-2" for="userStatus">
                                Account Status
                            </label>
                            <select class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" id="userStatus" name="status" required>
                ...
                <div class="mb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-gray-50" id="userCreatedAt" name="created_at" type="text" readonly>
                        </div>
                        <div>
                            <label class="block text-gray-700 text-sm font-medium mb-2" for="userLastLogin">
                                Last Login
                            </label>
                            <input class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-gray-50" id="userLastLogin" name="last_login" type="text" readonly>
                        </div>
                    </div>
                </div>
...
<div id="passwordConfirmationModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 hidden">
...
<div id="passwordResetSuccessModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 hidden">
