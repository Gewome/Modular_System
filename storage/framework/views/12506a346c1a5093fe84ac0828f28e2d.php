        ...
        <div class="overflow-x-auto">
            ...
            <table id="pendingTable" class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <!-- Details Modal -->
                    <div id="studentDetailsModal-<?php echo e($enrollment->id); ?>" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 hidden px-2">
                        <div class="bg-white rounded shadow-md w-full max-w-xl md:max-w-3xl p-4 md:p-8 overflow-y-auto max-h-[90vh] flex flex-col md:flex-row space-y-6 md:space-y-0 md:space-x-12">
                            <div class="flex-1 space-y-4 text-gray-700">
                                <div class="flex justify-between items-center">
                                    ...
                                    <button onclick="closeModal(<?php echo e($enrollment->id); ?>)" class="text-gray-500 hover:text-gray-700 text-3xl font-bold leading-none">&times;</button>
                                </div>
                                <!-- Profile Picture -->
                                <div class="flex-shrink-0 overflow-hidden mt-6 md:mt-0 flex-center justify-center bg-white p-2">
                                    <?php if($enrollment->photo): ?>
                                        <img src="<?php echo e(asset('storage/' . $enrollment->photo)); ?>" class="object-contain" style="max-width:100%; max-height:150px;" alt="Student Photo">
                                    <?php elseif($enrollment->user && $enrollment->user->photo): ?>
                                        <img src="<?php echo e(asset('storage/' . $enrollment->user->photo)); ?>" class="object-contain" style="max-width:100%; max-height:150px;" alt="User Photo">
                                    <?php else: ?>
                                ...
                                <div class="text-lg mb-6">
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div class="p-2">
                                            ...
                                            <p class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3"><?php echo e(\Illuminate\Support\Str::title($enrollment->last_name)); ?>, <?php echo e(\Illuminate\Support\Str::title($enrollment->first_name)); ?> <?php echo e(\Illuminate\Support\Str::title($enrollment->middle_name)); ?> <?php echo e(\Illuminate\Support\Str::title($enrollment->suffix_name)); ?></p>
                                        </div>
                                        <div class="p-2">
                                            <label class="block text-sm font-large text-black-700"><strong>Program:</strong></label>
                                            <p class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3"><?php echo e($enrollment->program->name ?? 'No Program'); ?></p>
                                        </div>
                                    </div>
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6"> 
                                        <div class="p-2">
                                            <label class="block text-sm font-medium text-black-700"><strong>Email Address:</strong></label>
                                            <p class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3"><?php echo e($enrollment->email); ?></p>
                                        </div>
                                        <div class="p-2">
                                            <label class="block text-sm font-medium text-black-700"><strong>Phone Number:</strong></label>
                                            <p class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3"><?php echo e($enrollment->phone ?? 'N/A'); ?></p>
                                        </div>
                                    </div>
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div class="p-2">
                                            <label class="block text-sm font-medium text-black-700"><strong>Birthdate:</strong></label>
                                            <p class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3"><?php echo e($enrollment->birthdate); ?></p>
                                        </div>
                                        <div class="p-2">
                                            <label class="block text-sm font-medium text-black-700"><strong>Age:</strong></label>
                                            <p class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3"><?php echo e($enrollment->age); ?></p>
                                        </div>
                                    </div>
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div class="p-2">
                                            <label class="block text-sm font-medium text-black-700"><strong>Gender:</strong></label>
                                            <p class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3"><?php echo e($enrollment->gender); ?></p>
                                        </div>
                                        <div class="p-2">
                                            <label class="block text-sm font-medium text-black-700"><strong>Status:</strong></label>
                                            <p class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3"><?php echo e($enrollment->status ?? 'Pending Review'); ?></p>
                                        </div>
                                    </div>
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div class="p-2">
                                            <label class="block text-sm font-medium text-black-700"><strong>Citizenship:</strong></label>
                                            <p class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3"><?php echo e($enrollment->citizenship ?? 'N/A'); ?></p>
                                        </div>
                                        <div class="p-2">
                                            <label class="block text-sm font-medium text-black-700"><strong>Religion:</strong></label>
                                            <p class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3"><?php echo e($enrollment->religion ?? 'N/A'); ?></p>
                                        </div>
                                    </div>
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div class="p-2">
                                            <label class="block text-sm font-medium text-black-700"><strong>Place of Birth:</strong></label>
                                            <p class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3"><?php echo e($enrollment->place_of_birth ?? 'N/A'); ?></p>
                                        </div>
                                        <div class="p-2">
                                            <label class="block text-sm font-medium text-black-700"><strong>Civil Status:</strong></label>
                                            <p class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3"><?php echo e($enrollment->civil_status ?? 'N/A'); ?></p>
                                        </div>
                                    </div>
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div class="p-2">
                                            <label class="block text-sm font-medium text-black-700"><strong>Guardian:</strong></label>
                                            <p class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3"><?php echo e($enrollment->guardian ?? 'N/A'); ?></p>
                                        </div>
                                        <div class="p-2">
                                            <label class="block text-sm font-medium text-black-700"><strong>Father's Name:</strong></label>
                                            <p class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3"><?php echo e($enrollment->father_name ?? 'N/A'); ?></p>
                                        </div>
                                    </div>
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div class="p-2">
                                            <label class="block text-sm font-medium text-black-700"><strong>Mother's Name:</strong></label>
                                            <p class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3"><?php echo e($enrollment->mother_name ?? 'N/A'); ?></p>
                                        </div>
                                        <div class="p-2">
                                            <label class="block text-sm font-medium text-black-700"><strong>Contact Number of Guardian:</strong></label>
                                            <p class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3"><?php echo e($enrollment->guardian_contact ?? 'N/A'); ?></p>
                                        </div>
                                    </div>
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div class="p-2">
                                            <label class="block text-sm font-medium text-black-700"><strong>Submission Date:</strong></label>
                                            <p class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3"><?php echo e(\Carbon\Carbon::parse($enrollment->created_at)->format('F d, Y')); ?></p>
                                        </div>
                                        <div class="p-2">
                                            <label class="block text-sm font-medium text-black-700"><strong>Parent Consent:</strong></label>
                                            <?php if($enrollment->parent_consent): ?>
                                                <a href="<?php echo e(asset('storage/' . $enrollment->parent_consent)); ?>" target="_blank" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 text-blue-600 hover:text-blue-800 hover:underline">
                                ...
                                <div class="flex space-x-4 py-2">
                                    <button onclick="confirmApprove(<?php echo e($enrollment->id); ?>)" class="px-4 py-2 bg-green-600 text-white rounded hover:bg-green-700">Approve</button>
                                    <button onclick="showRejectReason(<?php echo e($enrollment->id); ?>)" class="px-4 py-2 bg-red-600 text-white rounded hover:bg-red-700">Reject</button>
                                </div>
                                <div id="rejectReasonBox-<?php echo e($enrollment->id); ?>" class="mt-4 hidden">
                                    <label for="rejectReasonInput-<?php echo e($enrollment->id); ?>" class="block text-sm font-medium text-gray-700 mb-1">Reason</label>
                                    <textarea id="rejectReasonInput-<?php echo e($enrollment->id); ?>" rows="3" class="w-full border border-gray-300 rounded-md shadow-sm py-2 px-3"></textarea>
                                    <button onclick="confirmReject(<?php echo e($enrollment->id); ?>)" class="mt-2 px-4 py-2 bg-red-700 text-white rounded hover:bg-red-800">Submit Reason</button>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <table id="approvedTable" class="min-w-full divide-y divide-gray-200 hidden">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <div id="studentDetailsModal-approved-<?php echo e($enrollment->id); ?>" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 hidden px-2">
                        <div class="bg-white rounded shadow-md w-full max-w-xl md:max-w-3xl p-4 md:p-8 overflow-y-auto max-h-[90vh] flex flex-col md:flex-row space-y-6 md:space-y-0 md:space-x-12">
                            <div class="flex-1 space-y-4 text-gray-700">
                                <div class="flex justify-between items-center">
                                    <h2 class="text-2xl font-bold text-gray-900">Student Details</h2>
                                    <button onclick="closeModal(<?php echo e($enrollment->id); ?>, 'approved')" class="text-gray-500 hover:text-gray-700 text-3xl font-bold leading-none">&times;</button>
                                </div>
                                <!-- Profile Picture -->
                                <div class="flex-shrink-0 overflow-hidden mt-6 md:mt-0 flex-center justify-center bg-white p-2">
                                    <?php if($enrollment->photo): ?>
                                ...
                                <div class="text-lg mb-6">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        ...
                                        <div class="p-2">
                                            <label class="block text-sm font-medium text-black-700"><strong>Status:</strong></label>
                                            <select id="statusSelect-approved-<?php echo e($enrollment->id); ?>" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        ...
                                        <div class="p-2">
                                            ...
                                            <p class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3"><?php echo e($enrollment->approved_at ? \Carbon\Carbon::parse($enrollment->approved_at)->format('F d, Y') : 'N/A'); ?></p>
                                        </div>
                                    </div>
                                </div>
                                <!-- Save Button -->
            ...
            <table id="rejectedTable" class="min-w-full divide-y divide-gray-200 hidden">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <div id="studentDetailsModal-rejected-<?php echo e($enrollment->id); ?>" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 hidden px-2">
                        <div class="bg-white rounded shadow-md w-full max-w-xl md:max-w-3xl p-4 md:p-8 overflow-y-auto max-h-[90vh] flex flex-col md:flex-row space-y-6 md:space-y-0 md:space-x-12">
                            <div class="flex-1 space-y-4 text-gray-700">
                                <div class="flex justify-between items-center">
                                    <h2 class="text-2xl font-bold text-gray-900">Student Details</h2>
                                    <button onclick="closeModal(<?php echo e($enrollment->id); ?>, 'rejected')" class="text-gray-500 hover:text-gray-700 text-3xl font-bold leading-none">&times;</button>
                                </div>
                                <!-- Profile Picture -->
                                <div class="flex-shrink-0 overflow-hidden mt-6 md:mt-0 flex-center justify-center bg-white p-2">
                                    <?php if($enrollment->photo): ?>
                                ...
                                <div class="text-lg mb-6">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        ...
                                        <div class="p-2">
                                            <label class="block text-sm font-medium text-black-700"><strong>Status:</strong></label>
                                            <p class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3"><?php echo e($enrollment->status ?? 'Rejected'); ?></p>
                                        </div>
                                    </div>
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div class="p-2">
                                        ...
                                        <div class="p-2">
                                            ...
                                            <p class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3"><?php echo e($enrollment->rejection_reason ?? 'No reason provided'); ?></p>
                                        </div>
                                    </div>
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div class="p-2">
                                            <label class="block text-sm font-medium text-black-700"><strong>Rejected Date:</strong></label>
                                            <p class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3"><?php echo e($enrollment->rejected_at ? \Carbon\Carbon::parse($enrollment->rejected_at)->format('F d, Y') : 'N/A'); ?></p>
                                        </div>
                                        <div class="p-2">
                                            <label class="block text-sm font-medium text-black-700"><strong>Submission Date:</strong></label>
                                            <p class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3"><?php echo e(\Carbon\Carbon::parse($enrollment->created_at)->format('F d, Y')); ?></p>
