    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <div class="content-area flex-1 overflow-y-auto">
            ...
            <div class="p-6">
                ...
                @if($enrollmentStatusMessage)
                    <div class="mb-6">
                        <div class="alert alert-{{ $enrollmentStatusMessage['type'] }} rounded-lg p-4 border-l-4 border-{{ $enrollmentStatusMessage['type'] }}-500 bg-{{ $enrollmentStatusMessage['type'] }}-50">
                            <div class="flex items-start">
                                <div class="flex-shrink-0">
                                    @if($enrollmentStatusMessage['type'] === 'info')
                                        <svg class="h-5 w-5 text-{{ $enrollmentStatusMessage['type'] }}-500" viewBox="0 0 20 20" fill="currentColor">
                                    ...
                                    @elseif($enrollmentStatusMessage['type'] === 'success')
                                        <svg class="h-5 w-5 text-{{ $enrollmentStatusMessage['type'] }}-500" viewBox="0 0 20 20" fill="currentColor">
                                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" />
                                        </svg>
                                    @elseif($enrollmentStatusMessage['type'] === 'error')
                                        <svg class="h-5 w-5 text-{{ $enrollmentStatusMessage['type'] }}-500" viewBox="0 0 20 20" fill="currentColor">
                                ...
                                <div class="ml-3">
                                    <p class="text-sm font-medium text-{{ $enrollmentStatusMessage['type'] }}-800">
                            ...
                            <div class="p-8">
                                <div class="text-center mb-8">
                                    ...
                                    <p class="text-gray-600 mb-6 leading-relaxed">
                                        You must pay the registration fee of <span class="font-bold text-red-600 text-lg">₱{{ number_format($registrationFeeAmount, 2) }}</span>
                                ...
                                <div class="space-y-4">
                                    <button id="payButton" onclick="initiatePayMongoCheckout()" class="w-full bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white font-semibold py-4 px-6 rounded-xl transition-all duration-300 flex items-center justify-center shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                                        ...
                                        <span class="text-lg">Pay Registration Fee (₱{{ number_format($registrationFeeAmount, 2) }})</span>
                                    </button>
                                </div>
