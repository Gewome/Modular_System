...
<div class="flex-1 overflow-y-auto">
    <ul class="py-2 space-y-1">
        <!-- Dashboard -->
        <li style="cursor: pointer;" id="dashboardNav" data-url="{{ route('admin.dashboard') }}" class="nav-item group px-4 py-3 flex items-center hover:bg-blue-800/80 transition-all duration-200 rounded-lg mx-2 {{ request()->is('admin/dashboard') ? 'active-nav bg-blue-800/90' : '' }}">
        ...
        <li style="cursor: pointer;" id="enrollmentNav" data-url="{{ route('admin.enrollments') }}" class="nav-item group px-4 py-3 flex items-center hover:bg-blue-800/80 transition-all duration-200 rounded-lg mx-2 {{ request()->is('admin/enrollments') ? 'active-nav bg-blue-800/90' : '' }}">
            <div class="w-8 h-8 flex items-center justify-center bg-blue-700/30 group-hover:bg-blue-600/50 rounded-full transition-all">
        ...
        <!-- Enrolled Students -->
        <li style="cursor: pointer;" id="studentsNav" data-url="{{ route('admin.enrolled.students') }}" class="nav-item group px-4 py-3 flex items-center hover:bg-blue-800/80 transition-all duration-200 rounded-lg mx-2 {{ request()->is('admin/enrolled-students') ? 'active-nav bg-blue-800/90' : '' }}">
            <div class="w-8 h-8 flex items-center justify-center bg-blue-700/30 group-hover:bg-blue-600/50 rounded-full transition-all">
        ...
        <!-- Attendance -->
        <li style="cursor: pointer;" id="attendanceNav" data-url="{{ route('admin.attendance') }}" class="nav-item group px-4 py-3 flex items-center hover:bg-blue-800/80 transition-all duration-200 rounded-lg mx-2 {{ request()->is('admin/attendance') ? 'active-nav bg-blue-800/90' : '' }}">
            <div class="w-8 h-8 flex items-center justify-center bg-blue-700/30 group-hover:bg-blue-600/50 rounded-full transition-all">
        ...
        <!-- User Management -->
        <li style="cursor: pointer;" id="userNav" data-url="{{ route('admin.users') }}" class="nav-item group px-4 py-3 flex items-center hover:bg-blue-800/80 transition-all duration-200 rounded-lg mx-2 {{ request()->is('admin/users') ? 'active-nav bg-blue-800/90' : '' }}">
            <div class="w-8 h-8 flex items-center justify-center bg-blue-700/30 group-hover:bg-blue-600/50 rounded-full transition-all">
        ...
        <!-- Reports / Monitoring -->
        <li style="cursor: pointer;" id="reportNav" data-url="{{ route('admin.reports') }}" class="nav-item group px-4 py-3 flex items-center hover:bg-blue-800/80 transition-all duration-200 rounded-lg mx-2 {{ request()->is('admin/reports') ? 'active-nav bg-blue-800/90' : '' }}">
            <div class="w-8 h-8 flex items-center justify-center bg-blue-700/30 group-hover:bg-blue-600/50 rounded-full transition-all">
        ...
        <li style="cursor: pointer;" id="scheduleNav" data-url="{{ route('admin.schedules') }}" class="nav-item group px-4 py-3 flex items-center hover:bg-blue-800/80 transition-all duration-200 rounded-lg mx-2 {{ request()->is('admin/schedules') ? 'active-nav bg-blue-800/90' : '' }}">
            <div class="w-8 h-8 flex items-center justify-center bg-blue-700/30 group-hover:bg-blue-600/50 rounded-full transition-all">
        ...
        <!-- Certificates -->
        <li style="cursor: pointer;" id="certificateNav" data-url="{{ route('admin.certificates') }}" class="nav-item group px-4 py-3 flex items-center hover:bg-blue-800/80 transition-all duration-200 rounded-lg mx-2 {{ request()->is('admin/certificates') ? 'active-nav bg-blue-800/90' : '' }}">
            <div class="w-8 h-8 flex items-center justify-center bg-blue-700/30 group-hover:bg-blue-600/50 rounded-full transition-all">
