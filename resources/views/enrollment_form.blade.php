    ...
    <nav class="bg-gradient-to-b from-blue-900 to-blue-600 shadow-md sticky top-0 z-50">
        ...
        <div class="md:hidden hidden" id="mobile-menu">
            <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-gradient-to-b from-blue-900 to-blue-600">
                <a href="{{ route('welcome')}}" class="text-white hover:text-blue-300 block px<-3 py-2 rounded-md text-base font-medium">Home</a>
            ...
            <div class="bg-white p-8 rounded-lg shadow-md">
                ...
                <form id="enrollment-form" class="space-y-6" enctype="multipart/form-data">
                    ...
                    <div>
                        ...
                        <input type="date" id="birthdate" name="birthdate" max="{{ date('Y-m-d') }}" required class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                        <p class="text-red-600 text-sm mt-1 error-message"></p>
                    </div>
