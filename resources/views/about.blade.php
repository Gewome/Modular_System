    ...
    <section class="py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                <h2 class="text-3xl font-bold text-gray-800 mb-4">About Our Modular Classes</h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300">
                    ...
                    <h3 class="text-xl font-semibold text-gray-800 text-center mb-2">Flexible Schedule</h3>
                    <p class="text-gray-600 text-center">Learn at your own pace with scheduled assessments and instructor consultations.</p>
                </div>
                ...
                <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300">
                    ...
                    <h3 class="text-xl font-semibold text-gray-800 text-center mb-2">Hands-on Training</h3>
                    <p class="text-gray-600 text-center">Practical skills development with industry-standard equipment and facilities.</p>
                </div>
                ...
                <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300">
                    ...
                    <h3 class="text-xl font-semibold text-gray-800 text-center mb-2">Competency-Based</h3>
                    <p class="text-gray-600 text-center">Progress upon demonstrating mastery of each skill module.</p>
                </div>
            </div>
        </div>
    </section>
